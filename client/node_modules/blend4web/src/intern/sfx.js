...
// Use constant for third parameters of setTargetAtTime
// https://www.chromestatus.com/features/5287995770929152
var GAIN_CHANGE_DURATION = 0.015;
...
exports.attach_scene_sfx = function(scene) {
    ...
    if (_wa) {
        ...
        case "NONE":
            ...
            break;
        default:
            m_assert.panic("Wrong audio distance model");
        }
...
exports.update_object = function(bpy_obj, obj) {
    ...
    case "BACKGROUND_MUSIC":
        ...
        break;
    default:
        m_assert.panic("Wrong speaker behavior");
        break;
    }
...
exports.source_type = function(obj) {
    if (obj.type != "SPEAKER")
        m_assert.panic("Wrong object type");
    ...
    for (var cnt = 0; cnt < SCHED_PARAM_LOOPS; ) {
        ...
        if (time >= sfx.vp_rand_end_time) {
            if (sfx.volume_random) {
                ...
                rand_gnode.gain.setTargetAtTime(gain, time, GAIN_CHANGE_DURATION);
            }

            if (sfx.pitch_random) {
                source.playbackRate.setTargetAtTime(playrate, time, GAIN_CHANGE_DURATION);
                if (sfx.source_node2)
                    sfx.source_node2.playbackRate.setTargetAtTime(playrate, time, GAIN_CHANGE_DURATION);
            }
...
function stop(sobj) {
    ...
    if (sfx.fade_out) {
        fade_gnode.gain.setTargetAtTime(fade_gnode.gain.value, current_time, GAIN_CHANGE_DURATION);
        fade_gnode.gain.linearRampToValueAtTime(0, current_time + sfx.fade_out, GAIN_CHANGE_DURATION);
    }
