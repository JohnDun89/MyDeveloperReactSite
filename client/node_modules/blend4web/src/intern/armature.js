...
export function update_object(bpy_armobj, armobj) {
 ...
 */
export function get_bone_tsr(armobj, bone_name, get_pose_tail,
...
export function set_bone_tsr(armobj, bone_name, tsr, use_bone_space) {
    var render = armobj.render;
    var bone_pointer = render.bone_pointers[bone_name];
    var trans_before = render.trans_before;
    var quats_before = render.quats_before;
...
export function update_skinned_renders(armobj) {
    var render = armobj.render;
