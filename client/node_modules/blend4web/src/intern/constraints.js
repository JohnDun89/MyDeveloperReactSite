...
function assign_parent_descendant(obj_parent, obj) {
    if (obj_parent.cons_descends.indexOf(obj) == -1)
        ...
        m_assert.panic("Descendant object override is forbidden");
}
...
function remove_parent_descendant(obj_parent, obj) {
    ...
    if (ind != -1)
        ...
        m_assert.panic("No descendant object");
}
...
function clamp_orientation(obj, cons) {
    ...
    var base_angles = m_cam.get_camera_angles_from_quat(quat_base, obj.render.vertical_axis, _vec2_tmp);
    var curr_angles = m_cam.get_camera_angles_from_quat(quat, obj.render.vertical_axis, _vec2_tmp_2);
