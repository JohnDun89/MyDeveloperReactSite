...
import m_debug_fact from "../intern/debug.js";
import m_debug_batch_fact from "../intern/debug/batch.js";
import m_debug_check_fact from "../intern/debug/check.js";
import m_debug_subscene_fact from "../intern/debug/subscene.js";
import m_debug_telemetry_fact from "../intern/debug/telemetry.js";

import m_debug_render_time_fact from "../intern/debug/render_time.js";
import m_ext_fact from "../intern/extensions.js";
import m_geom_fact from "../intern/geometry.js";
import m_load_fact from "../intern/loader.js";
...
import m_scgraph_fact from "../intern/scenegraph.js";
import m_sfx_fact from "../intern/sfx.js";
import m_shaders_fact from "../intern/shaders.js";
import m_subs_fact from "../intern/subscene.js";
...
var m_debug_batch = m_debug_batch_fact(ns);
...
var m_debug_render_time = m_debug_render_time_fact(ns);
 ...
 */
exports.DV_TRANSPARENT_WIREFRAME = m_debug_subscene.DV_TRANSPARENT_WIREFRAME;
...
exports.msg = function() {
    m_debug_telemetry.msg.apply(m_debug_telemetry, arguments);
}
...
exports.fbmsg = function() {
    m_debug_telemetry.fbmsg.apply(m_debug_telemetry, arguments);
}
 ...
 */
exports.print_telemetry = function() {
    m_debug_telemetry.print_telemetry.apply(m_debug_telemetry, arguments);
}
 ...
 */
exports.plot_telemetry = function() {
    m_debug_telemetry.plot_telemetry.apply(m_debug_telemetry, arguments);
}
...
exports.fbres = function(fun, timeout) {
    ...
    var cb = function() {
        m_debug_telemetry.fbmsg("FBRES", fun());
...
exports.set_debug_params = function(params) {
    ...
    for (var i = 0; i < subs_debug_views.length; i++) {
        ...
        if (typeof params.debug_view_mode == "number") {
            ...
            case m_debug_subscene.DV_NONE:
            case m_debug_subscene.DV_OPAQUE_WIREFRAME:
            case m_debug_subscene.DV_TRANSPARENT_WIREFRAME:
            case m_debug_subscene.DV_FRONT_BACK_VIEW:
            case m_debug_subscene.DV_BOUNDINGS:
            case m_debug_subscene.DV_CLUSTERS_VIEW:
            case m_debug_subscene.DV_BATCHES_VIEW:
            case m_debug_subscene.DV_RENDER_TIME:
...
exports.fake_load = function(stageload_cb, interval, start, end, loaded_cb) {
    ...
    if (!stageload_cb)
        m_assert.panic("Stage load callback is undefined");
    ...
    if (end > 100)
        m_assert.panic("Max percentage must be less than 100");

    if (start < 0)
        m_assert.panic("Min percentage must be greater than 0");

    if (start > end)
        m_assert.panic("Max percentage must be greater than min percentage");
...
function get_shaders_stat(vshader, fshader) {
    ...
    return {
        vsrc: m_context.get_gl().getShaderSource(vshader),
        vsrc_trans: vsrc_trans,
        vout: vout,
        vstats: vstats,
        fsrc: m_context.get_gl().getShaderSource(fshader),
...
exports.test_performance = function(callback) {
    ...
    window.setTimeout(function() {
        m_debug_render_time.process_timer_queries(subs);
        // in ms
...
exports.print_batches_stat = function() {
    m_debug_batch.print_batches_stat();
}
...
exports.start_debug = function(module) {
    _called_funcs = [];
    _test_result = true;

    if (typeof module === "string")
        module = b4w.require(module);
...
exports.pix = function(ref_color) {
    ...
    if (!subs)
        m_assert.panic("Couldn't find onscreen subscene");
